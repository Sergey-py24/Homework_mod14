...
api = '8193327083:AAFGqwLJcbQJ2ggUO6Dl8Z0269zge0wEaXk'
bot = Bot(token=api)
...
async def get_buying_list(message):
    with open('Продукт1.jpg', 'rb') as image:
        await message.answer_photo(image, f'{get_all_products()[0]}')
    with open('Продукт2.jpg', 'rb') as image:
        await message.answer_photo(image, f'{get_all_products()[1]}')
    with open('Продукт3.jpg', 'rb') as image:
        await message.answer_photo(image, f'{get_all_products()[2]}')
    with open('Продукт4.jpg', 'rb') as image:
        await message.answer_photo(image, f'{get_all_products()[3]}')
