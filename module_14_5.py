...
button11 = KeyboardButton(text='Регистрация')
kb.row(button, button11)
...
async def sing_up(message):
    await message.answer('Введите имя пользователя (только латинница):')
